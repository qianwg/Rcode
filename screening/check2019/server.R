...
shinyServer(function(input, output) {
    ...
    family<-c('外唇癌','唇癌','舌癌','牙龈癌','口底癌','口腔癌','腮腺癌','大涎腺癌',
              ...
              '肺癌/骨癌','乳腺啊','肝癌乳腺癌','胃癌，肺癌','乳腺癌卵巢癌','肺癌、肾癌','子宫癌肝癌','胃癌91',
              '胃癌喷门','胃，肝癌','乳腺癌肺癌','乳腺癌/肺癌','乳腺癌、胃癌','乳腺癌、胰腺','肺癌乳腺癌','肺癌甲状腺癌','胃癌食道癌',
              '賁门癌','肝癌、肺癌','肺癌、胰腺癌','膀胱癌/肺癌','直肠癌肺癌','3胃癌 乳腺癌','乳腺癌 胆管','肺癌、乳腺癌','肺癌  其它癌',
              '乳腺癌、肺癌'
    )
    family2<-c('外唇癌'=1,'唇癌'=2,'舌癌'=3,'牙龈癌'=4,'口底癌'=5,'口腔癌'=6,'腮腺癌'=7,'大涎腺癌'=8,
               ...
               '淋巴癌，肺癌'=34, '肺癌/骨癌'=34,'乳腺啊'=47,'肝癌乳腺癌'=24,'胃癌，肺癌'=34,'乳腺癌卵巢癌'=47,'肺癌、肾癌'=34,'子宫癌肝癌'=24,'胃癌91'=16,
               '胃癌喷门'=16,'胃，肝癌'=24,'乳腺癌肺癌'=34,'乳腺癌/肺癌'=34,'乳腺癌、胃癌'=47,'乳腺癌、胰腺'=47,'肺癌乳腺癌'=34,'肺癌甲状腺癌'=34,
               '胃癌食道癌'=16,'賁门癌'=16,'肝癌、肺癌'=34,'肺癌、胰腺癌'=34,'膀胱癌/肺癌'=34,'直肠癌肺癌'=34,'3胃癌 乳腺癌'=47,'乳腺癌 胆管'=47,
               '肺癌、乳腺癌'=47,'肺癌  其它癌'=34,'乳腺癌、肺癌'=47
    )
    ##家族史情况
    familytab<-reactive({
    ...
    questionare<-function(data){
        ...
        check7_1<-ifelse(is.na(cellphone) & is.na(telephone),1,0)
        ...
        check25_1<-ifelse(!is.na(persoid),ifelse(nchar(persoid)==18,0,ifelse(nchar(persoid)==15,0,1)),0)
        check25_2<-ifelse((abs((as.Date('2019-01-01')-as.Date(substr(persoid,7,14),'%Y%m%d'))/365)-age)<10,0,1)
        check25<-ifelse(check25_1==1 | check25_2==1 | is.na(check25_2),1,0)
        ...
        check40_1<-ifelse(!is.na(menopause) & !is.na(sex) & !is.na(agemenopau) & !is.na(age),ifelse(sex==2 & menopause==2 & agemenopau<99 & agemenopau>age & agemenopau<agefirdeli,1,0),0)
        ...
        check42_2<-ifelse(sex==2,ifelse(deliver==2,ifelse(delivertim<=10 & delivertim>=1 & agefirdeli<=age & agefirdeli>agemenarch,0,1),0),0)
