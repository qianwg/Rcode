library(openxlsx)
pepsinogen2020<-read.xlsx('~/data/2020/示范区--2020-09-22.xlsx',detectDates=TRUE)
pepsinogen2020[,-which(names(pepsinogen2020) %in% c('NAME','ID18','Name2'))]<-as.data.frame(
  apply(pepsinogen2020[,-which(names(pepsinogen2020) %in% c('NAME','ID18','Name2'))],2,as.numeric))
...
data_PG2020<-import('~/data/2020/PG--2020-09-22.xlsx')
data_PG2020<-data_PG2020%>%transmute(
  ID=筛查编号,name_PG=姓名,sex_PG=性别1男2女,age_PG=年龄,PG1=as.numeric(PGI),
...
data_Hp2020<-import('~/data/2020/Hp--2020-09-22.xlsx')

data_Hp2020<-data_Hp2020%>%transmute(
  F_ID_Hp=F_ID,name_Hp=NAME,persoID=ID18,C14Value=as.numeric(C14Value),Hp_pos=factor(Result,levels=c(1,2),labels=c('阴性','阳性'))
)
pepsinogen2020<-inner_join(pepsinogen2020,data_PG2020,by='ID')
pepsinogen2020<-inner_join(pepsinogen2020,data_Hp2020,by='persoID')
pepsinogen2020$PG_hp<-NA
pepsinogen2020$PG_hp[pepsinogen2020$Hp_pos=="阴性" & pepsinogen2020$PG_pos=='阴性']<-1
pepsinogen2020$PG_hp[pepsinogen2020$Hp_pos=="阳性" & pepsinogen2020$PG_pos=='阴性']<-2
pepsinogen2020$PG_hp[pepsinogen2020$Hp_pos=="阳性" & pepsinogen2020$PG_pos=='阳性']<-3
pepsinogen2020$PG_hp[pepsinogen2020$Hp_pos=="阴性" & pepsinogen2020$PG_pos=='阳性']<-4
pepsinogen2020$PG_hp<-factor(pepsinogen2020$PG_hp,levels=c(1,2,3,4),labels=c('A','B','C','D'))
